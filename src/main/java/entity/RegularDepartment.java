 ...
 */
 ...
 public class RegularDepartment extends Department  implements PrintableMenuSelection  {
    ...
    public RegularDepartment(String name) {
        super(name);
     ...
     * @throws IllegalArgumentException Biti će bacena ako se unese prazno ime
     */
    public static RegularDepartment generateDepartment(Scanner sc) throws IllegalArgumentException {
        ...
        return new RegularDepartment(name);
    }
